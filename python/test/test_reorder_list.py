...
class Tests(unittest.TestCase):
    def test_1(self):
        l1n1, l1n2, l1n3, l1n4 = ListNode(1), ListNode(2), ListNode(3), ListNode(4)
        l1n1.next = l1n2
        l1n2.next = l1n3
        l1n3.next = l1n4
        trn1, trn2, trn3, trn4 = ListNode(1), ListNode(4), ListNode(2), ListNode(3)
        trn1.next = trn2
        trn2.next = trn3
        trn3.next = trn4
    ...
    def test_2(self):
        l1n1, l1n2, l1n3, l1n4, l1n5 = ListNode(1), ListNode(2), ListNode(3), ListNode(4), ListNode(5)
        l1n1.next = l1n2
        l1n2.next = l1n3
        l1n3.next = l1n4
        l1n4.next = l1n5
        trn1, trn2, trn3, trn4, trn5 = ListNode(1), ListNode(5), ListNode(2), ListNode(4), ListNode(3)
        trn1.next = trn2
        trn2.next = trn3
        trn3.next = trn4
        actual_result = Solution()
