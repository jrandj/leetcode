...
final class ThreeSum {
    ...
    public static List<List<Integer>> threeSum(final int[] nums) {
        ...
        /*
         * for each number, look for 2 subsequent numbers that give a total sum
         * of 0
         */
            ...
            if (i == 0 || nums[i] != nums[i - 1]) {
                ...
                while (low < high) {
                    if (nums[low] + nums[high] == sum) {
                        ...
                        /*
                         * increment search bounds but skip over duplicates
                         * first if a number is the same as the previous number
                         * skip it
                         */
                        ...
                        /*
                         * if a number is the same as the previous number skip
                         * it skip it
                         */
